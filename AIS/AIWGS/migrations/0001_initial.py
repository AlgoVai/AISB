...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Menus',
            fields=[
                ('MenueId', models.AutoField(primary_key=True, serialize=False)),
                ('MenueName', models.CharField(max_length=500)),
                ('MenusUrl', models.CharField(max_length=500)),
                ('CreatedAt', models.DateTimeField()),
                ('ModuleId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AIWGS.modules')),
            ],
            options={
                'db_table': 'Menus',
                'ordering': ['MenueId'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IsActive', models.BooleanField(default=False)),
                ('MenuesId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AIWGS.menus')),
